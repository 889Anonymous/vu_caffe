        ...
        {menuLoading ? (
          ...
          <div className="flex items-center justify-center h-96">
            <div className="text-red-600 text-center">
              <p className="text-lg font-medium">{t('menu.error_loading')}</p>
          ...
          <div className="flex items-center justify-center h-96">
            <div className="text-gray-500 text-center">
              <p className="text-lg font-medium">{t('menu.no_items')}</p>
              <p className="text-sm mt-2">{t('menu.no_items_hint')}</p>
            </div>
          </div>
        ) : (
          <div className={cn(
