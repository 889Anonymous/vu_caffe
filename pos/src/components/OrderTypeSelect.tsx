...
// Map order type values to translation keys
const ORDER_TYPE_I18N_KEY: Record<string, string> = {
  'Dine In': 'order_type.dine_in',
  'Take Away': 'order_type.takeaway',
  'Delivery': 'order_type.delivery',
  'Phone In': 'order_type.phone_in',
  'Aggregators': 'order_type.aggregators',
};
    ...
    <div>
      <div className="flex gap-2 overflow-x-auto pb-2 -mx-2 px-2">
        {ORDER_TYPES.map(({ label, value, icon: Icon }) => {
          ...
          const translatedLabel = t(ORDER_TYPE_I18N_KEY[value] || value);
          ...
          return (
            <Button
              ...
              disabled={isDisabled}
              title={isDineIn && isRestrictedFromTableOrders ? t('order_type.dine_in_restricted') : undefined}
            >
