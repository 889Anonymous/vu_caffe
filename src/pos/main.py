...
# Fix relative imports for package structure
...
app = FastAPI(title="POS System") # Neutral title

# Ensure static and templates paths are correct relative to project root
